...
template <>
InputParameters
validParams<Polycrystal2KernelAction>()
{
...
Polycrystal2KernelAction::Polycrystal2KernelAction(const InputParameters & params)
  : Action(params),
...
Polycrystal2KernelAction::act()
{
  for (unsigned int op = 0; op < _op_num; ++op)
  {
    ...
    {
      InputParameters params = _factory.getValidParams("ACGrGrPoly2");
      ...
      _problem->addKernel("ACGrGrPoly2", kernel_name, params);
    }
